...
- **Метрики**: Средний confidence ~0.66 (из тестов), std ~0.15, min ~0.35, max ~0.95. Общее детекций ~5000–6000. В сложных частях (толпа >10 человек) recall ~80–85%, precision ~85–90%.
